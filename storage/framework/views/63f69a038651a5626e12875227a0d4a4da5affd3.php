            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li class="">
							<a href="#"><i class="fa fa-dollar nav_icon"></i>Markets<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
						...
						<li>
							<a href="<?php echo e(url('dashboard/transaction')); ?>"><i class="fa fa-chevron-circle-down nav_icon"></i> Transactions</a>
						</li>
						...
						<li class="">
							<a href="#"><i class="fa fa-gears (alias) nav_icon"></i>Account types <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="<?php echo e(url('dashboard/mplans')); ?>"><i class="fa fa-list nav_icon"></i>Account types</a>
									<a href="<?php echo e(url('dashboard/myplans')); ?>"><i class="fa fa-eye nav_icon"></i>My account</a>
								</li>
							</ul>
							<!-- /nav-second-level -->
						</li>
						...
						<li class="">
							<a href="#"><i class="fa fa-cog nav_icon"></i>Manage Account types <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
			...
			<div class="header-left">
				...
				<div class="logo" style="padding:5px; width:200px;">
					<a href="<?php echo e(url('/')); ?>" style="padding-left:10px !important;">
						<img src="<?php echo e(asset('images/'.$settings->logo)); ?>" alt="<?php echo e($settings->site_name); ?>" title="" class="logodash"style=" width:150px; margin-top: -12px" />
					</a>
				</div>
				<!--//logo-->
