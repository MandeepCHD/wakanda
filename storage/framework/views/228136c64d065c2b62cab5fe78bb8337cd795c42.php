  ...
  <header id="header">
    <div class="container-fluid">
      <div id="logo" class="pull-left mt-0">
        ...
        <a href="#intro"><img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($settings->logo); ?>" alt="<?php echo e($settings->site_name); ?>" title="" class="mt-0 logo" /></a>
      </div>
