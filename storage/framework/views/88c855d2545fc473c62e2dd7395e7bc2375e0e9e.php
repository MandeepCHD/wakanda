					...
					<table class="table table-hover"> 
						...
						<tbody> 
							...
							<td>
								 ...
								 <?php endif; ?>
								 <?php if($list->type=='1' || $list->type=='2'): ?>
								 <a class="btn btn-danger" href="<?php echo e(url('dashboard/makeadmin')); ?>/<?php echo e($list->id); ?>/off">Remove admin</a> 
								 <?php else: ?>
								...
								<td><?php echo e($list->id); ?></td>
								 ...
								 <td>NULL</td>
								 <?php endif; ?> 
								 <td><?php echo e($list->auto_trade); ?></td> 
							...
							<div class="modal-dialog">
								...
								<div class="modal-body">
										<form style="padding:3px;" role="form" method="post" action="<?php echo e(action('SomeController@topup')); ?>">
											...
											<input type="hidden" name="user_pln" value="<?php echo e($list->plan); ?>">
										...
										<div class="modal-body">
												<form style="padding:3px;" role="form" method="post" action="<?php echo e(action('UsersController@sendmailtooneuser')); ?>">
													...
													<input type="text" name="subject" class="form-control" id="" placeholder="Subject" required>
							  						 <br>
													<textarea class="form-control" placeholder="Message" name="message" row="3" required=""></textarea><br/>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												...
												<div class="form-group">
													...
													<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
													<input type="submit" class="btn btn-success" value="Add History">
											</form>
										</div>
										</div>
									</div>
					...
					<!-- Edit user Modal -->
							...
							<div class="modal-dialog">
								...
								<div class="modal-body">
									...
									<h3>Abc123</h3><br>
									<a class="btn btn-success" href="<?php echo e(url('dashboard/resetpswd')); ?>/<?php echo e($list->id); ?>">Proceed</a>
								</div>
								</div>
							</div>
							</div>
							...
							<div class="modal-dialog">
								...
								<div class="modal-body">
									<a class="btn btn-success" href="<?php echo e(url('dashboard/clearacct')); ?>/<?php echo e($list->id); ?>">Proceed</a>
								</div>
								</div>
							</div>
							</div>
