...
<?php $trade = app('App\Http\Controllers\BuySellController'); ?>
		...
		<div id="page-wrapper" style="padding-left:0px; padding-right:5px;">
			...
			<?php if(Session::has('message')): ?>
				...
				<div class="row" style="background-color:#fff; padding:10px 10px 10px 10px;">
							...
							<div class="col-lg-7 col-md-7 col-sm-7">
    							<button class="btn btn-danger d-inline" data-toggle="modal" data-target="#sellModal">Sell</button>
    							<button class="btn btn-success d-inline" data-toggle="modal" data-target="#buyModal">Buy</button>
    							...
    							<strong>Account Type:</strong> <?php echo e($pname); ?> 
    							<?php if(Auth::user()->acnt_type_active == "no"): ?>
							...
							<strong class="btn btn-success" style="float:right;">Bal: <?php echo e($settings->currency); ?><?php echo e(number_format(Auth::user()->account_bal, 2, '.', ',')); ?></strong>
							
							</div>
					<div class="clearfix"> </div>
				</div>

				<div class="row-one" style="margin-top:10px; text-align:center;">
				...
				<div class="modal-body">
					<form  id="buyorder" role="form" method="post" action="javascript:void(0)">
						...
						<div class="form-row mb-3" >
							...
							<input type="text"  name="stoploss" class="form-control" placeholder="0.000" required>
							</div>
							<div class="col-md-6 mb-3"  style="margin-bottom: 5px">
							<label>Take Profit</label>
							<input type="text"  name="takeprofit" class="form-control" placeholder="0.000" required>
							</div>
						</div>
