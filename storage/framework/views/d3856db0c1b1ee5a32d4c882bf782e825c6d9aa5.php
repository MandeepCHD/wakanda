		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
                ...
                <?php endif; ?>
							...
							<div class="panel panel-default" style="border:0px solid #fff;">
								...
								<div id="eth" class="panel-collapse collapse">
									<div class="alert alert-success alert-dismissable">
										...
										<a href="<?php echo e(url('dashboard/cpay')); ?>/<?php echo e($amount); ?>/ETH/<?php echo e(Auth::user()->id); ?>/new" class="btn btn-success">Automatic payment method</a>
										<?php endif; ?>
										</h4>
									</div>
								</div>
							...
							<div class="panel panel-default" style="border:0px solid #fff;">
								...
								<div id="btc" class="panel-collapse collapse">
									<div class="alert alert-success alert-dismissable">
										...
										<br/><br/>
										<?php if($settings->withdrawal_option != "manual"): ?>
										<a href="<?php echo e(url('dashboard/cpay')); ?>/<?php echo e($amount); ?>/BTC/<?php echo e(Auth::user()->id); ?>/new" class="btn btn-success">Automatic payment method</a>
										<?php endif; ?>
										</h4>
									</div>
								</div>
							...
							<div class="panel panel-default" style="border:0px solid #fff;">
								...
								<div id="ltc" class="panel-collapse collapse">
									<div class="alert alert-success alert-dismissable">
										...
										<br/><br/>
										<?php if($settings->withdrawal_option != "manual"): ?>
										<a href="<?php echo e(url('dashboard/cpay')); ?>/<?php echo e($amount); ?>/LTC/<?php echo e(Auth::user()->id); ?>/new" class="btn btn-success">Automatic payment method</a>
										<?php endif; ?>
										</h4>
									</div>
								</div>
							...
							<div class="panel panel-default" style="border:0px solid #fff;">
								...
								<div id="stripe" class="panel-collapse collapse">
									<div class="alert alert-success alert-dismissable">
										...
										<br/>
										<a href="<?php echo e(url('dashboard/paywithcard')); ?>/<?php echo e($amount); ?>" class="btn btn-success">Pay with card</a>
					...
					<form method="post" action="<?php echo e(action('SomeController@savedeposit')); ?>" enctype="multipart/form-data" style="background-color:#171e2b	#fff; padding:20px; margin-top:10px;">
					<div class="sign-u">
						<div class="sign-up1">
