					...
					<ul class="nav nav-tabs">
						...
						<div class="tab-content ">
													...
													<div class="modal-dialog">
														...
														<div class="modal-body">
																<form style="padding:3px;" role="form" method="post" action="<?php echo e(action('SomeController@updatemark')); ?>">
																	...
																	<input style="padding:5px;" class="form-control" type="text" name="quote_currency" value="<?php echo e($market->quote_curr); ?>"><br/>
							...
							<div class="tab-pane active" id="8">
								<div class="sign-up-row widget-shadow">
									<form method="post" action="<?php echo e(action('SomeController@updateemail')); ?>">
										<div class="sign-u">
											<div class="sign-up1">
											...
											<div class="sign-up2">
												...
												<input type="text" placeholder="Subject" name="regsubject" value=" <?php echo e($settings->regsubject); ?>" id="">
											</div>
											<div class="sign-up2">
												<textarea name="regmessage" class="form-control" rows="5"><?php echo e($settings->regmessage); ?></textarea>
											</div>
											<div class="clearfix"> </div>
										</div>
										<div class="sub_home">
