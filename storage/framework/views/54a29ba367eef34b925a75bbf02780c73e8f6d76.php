					...
					<table class="table table-hover" id="table"> 
						...
						<tbody> 
							...
							<tr> 
								 ...
								 <td><?php echo e($deposit->orders); ?></td> 
								 ...
								 <td><?php echo e($deposit->profit); ?></td> 
                                 <td><?php echo e($deposit->loss); ?></td> 
								...
								<div class="modal-body">
                                    <form  id="buyorder" role="form" method="post" action="<?php echo e(action('Controller@editorder')); ?>">
                                        ...
                                        <div class="form-row mb-3" >
                                            <div class="col-md-6 mb-3"  style="margin-bottom: 5px">
                                            <label>Profit</label>
                                            <input type="text" value="<?php echo e($deposit->profit); ?>"  name="profit" class="form-control">
                                            </div>
                                            <div class="col-md-6 mb-3"  style="margin-bottom: 5px">
                                            <label>Loss</label>
                                            <input type="text" value="<?php echo e($deposit->loss); ?>" name="loss" class="form-control">
                                            </div>
                                        </div>
