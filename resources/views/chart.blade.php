...
function getMarketPrice(masset){
  $.ajax({
    url: "{{url('/dashboard/getMarketPrice')}}/"+masset,
    type: 'GET',
...
function updatemarketform(masset){
  ...
  document.getElementById("bmarket").value = masset;
  document.getElementById("smarket").value = masset;
}

//get chart market
function getTradeAssets(market){
  $.ajax({
    url: "{{url('/dashboard/getTradeAssets')}}/"+market,
    type: 'GET',
