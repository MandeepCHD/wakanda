					...
					<table class="table table-hover"> 
						...
						<tbody> 
							...
							<td>
								 ...
								 <a class="btn btn-danger" href="{{ url('dashboard/makeadmin') }}/{{$list->id}}/off">Remove admin</a> 
								 @else
							...
							<div class="modal-dialog">
								...
								<div class="modal-body">
										<form style="padding:3px;" role="form" method="post" action="{{action('SomeController@topup')}}">
											...
											<input type="hidden" name="user_pln" value="{{$list->plan}}">
					...
					<!-- Edit user Modal -->
							...
							<div class="modal-dialog">
								...
								<div class="modal-body">
									...
									<h3>Abc123</h3><br>
									<a class="btn btn-success" href="{{ url('dashboard/resetpswd') }}/{{$list->id}}">Proceed</a>
								</div>
								</div>
							</div>
							</div>
							...
							<div class="modal-dialog">
								...
								<div class="modal-body">
									<a class="btn btn-success" href="{{ url('dashboard/clearacct') }}/{{$list->id}}">Proceed</a>
								</div>
								</div>
							</div>
							</div>
